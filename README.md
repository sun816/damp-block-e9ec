...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/damp-block-e9ec
```

A live public deployment of this template is available at [https://damp-block-e9ec.templates.workers.dev](https://damp-block-e9ec.templates.workers.dev)
